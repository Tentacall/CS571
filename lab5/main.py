...
class Solution:
    ...
    def search(self, matrix, x, y , hurestic ):
        ...
        visited = {} # closed list
        # initialize
        queue.put((1, MAX_POSSIBLE_STEP, 0, x, y, matrix))
        while not queue.empty() and not result_found:
            for _ in range(self.epoch):
                p, fn, gn, x, y, mat = queue.get()
                fn_curr = fn
                # print(fn, gn)
                ...
                for op in operations:
                    ...
                    if mat2 is not None:
                        ...
                        p = self.probability(fn_curr, fn, self.T)
                        queue.put((p, fn ,gn + 1, x2, y2, mat2) )
